 ...
 * one of the characteristic classes in {@link com.beowulfe.hap.characteristics} when creating custom accessory types
 * (the standard accessories from {@link com.beowulfe.hap.accessories} already include the necessary characteristics),
